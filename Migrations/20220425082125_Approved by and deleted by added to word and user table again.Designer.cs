...
namespace NaijaPidginAPI.Migrations
{
    ...
    [Migration("20220425082125_Approved by and deleted by added to word and user table again")]
    partial class Approvedbyanddeletedbyaddedtowordandusertableagain
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NaijaPidginAPI.Entities.Word", b =>
                {
                    b.HasOne("NaijaPidginAPI.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("ApprovedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NaijaPidginAPI.Entities.User", "Deleter")
                        .WithMany()
                        .HasForeignKey("DeletedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NaijaPidginAPI.Entities.User", "Poster")
                        .WithMany()
